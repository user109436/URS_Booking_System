...
function readFormData() {
    ...
    formData["newInputUserNumber"] = document.getElementById("newInputUserNumber").value;
    formData["newInputFirstName"] = document.getElementById("newInputFirstName").value;
    formData["newInputLastName"] = document.getElementById("newInputLastName").value;
    formData["newInputPosition"] = document.getElementById("newInputPosition").value;
    formData["newInputEmail"] = document.getElementById("newInputEmail").value;
    formData["newInputPassword"] = document.getElementById("newInputPassword").value;
    formData["newInputRole"] = document.getElementById("newInputRole").value;
    formData["newInputVerified"] = document.getElementById("newInputVerified").value;
    formData["newInputStatus"] = document.getElementById("newInputStatus").value;
    formData["newInputCreated"] = document.getElementById("newInputCreated").value;
    formData["newInputUpdated"] = document.getElementById("newInputUpdated").value;
    return formData;
}
...
function onEdit(td) {
    ...
    document.getElementById("newInputUserNumber").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputFirstName").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputLastName").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputPosition").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputEmail").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputPassword").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputRole").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputVerified").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputStatus").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputCreated").value = selectedRow.cells[6].innerHTML;
    document.getElementById("newInputUpdated").value = selectedRow.cells[6].innerHTML;
